...
const dictionaries = {
  tr: {
    ...
    calendar_empty: "Bugün için planlanmış bir ilaç yok.",
    calendar_setup_hint: "İlaçlarım sekmesinden doz saatleri ekleyebilirsiniz.",
    calendar_upcoming_title: "Alınacak İlaçlar",
    calendar_all_taken: "Bugünkü tüm ilaçlarınızı aldınız. 🎉",
    calendar_taken_title: "Alınan İlaçlar",
    calendar_none_taken: "Henüz bir ilaç işaretlenmedi.",
    calendar_mark_taken: "Aldım",
    calendar_undo: "Geri Al",
  ...
  en: {
    ...
    calendar_empty: "No medicines scheduled for today.",
    calendar_setup_hint: "You can add dose times from the My Medicines tab.",
    calendar_upcoming_title: "To Take",
    calendar_all_taken: "You've taken all of today's medicines. 🎉",
    calendar_taken_title: "Taken",
    calendar_none_taken: "No medicine marked yet.",
    calendar_mark_taken: "Taken",
    calendar_undo: "Undo",
