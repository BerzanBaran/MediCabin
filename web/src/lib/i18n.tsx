...
const dictionaries = {
  tr: {
    ...
    guide_nav_photo: "Fotoğrafla Analiz Et",
    ...
    photo_title: "İlacınızı fotoğraflayın veya yükleyin",
    photo_subtitle:
      "İlaç kutusu, blister veya prospektüs fotoğrafı çekin ya da yükleyin — yerel ilaç dolabınızla eşleştirelim.",
    photo_camera_button: "Kameradan Çek",
    photo_gallery_button: "Galeriden Seç",
    photo_upload_button: "Bilgisayardan Yükle",
    photo_analyze_button: "Analiz Et",
    photo_analyzing: "Analiz ediliyor…",
    photo_remove_button: "Kaldır",
    photo_result_title: "Analiz Sonucu",
    photo_matched_prefix: "Eşleşen ilaç:",
    photo_no_match: "Dolabınızdaki ilaçlarla bir eşleşme bulunamadı.",
    photo_error_type: "Sadece resim dosyası yükleyebilirsiniz (JPEG, PNG, WEBP).",
    photo_disclaimer:
      "Bu analiz yapay zekâ (Gemini) tarafından üretilir, hatalı olabilir. Kesin bilgi için prospektüsü kontrol edin veya eczacınıza danışın.",

    calendar_prev: "← Önceki",
    calendar_next: "Sonraki →",
    calendar_today: "Bugün",
    calendar_empty: "Bu tarih için hatırlatıcı yok.",
    calendar_taken: "Alındı",
    calendar_future_note: "Gelecek tarihler için alındı işareti konulamaz.",
    calendar_add_title: "Yeni Hatırlatıcı Ekle",
    calendar_person_label: "Kişi",
    calendar_person_self: "Siz",
    calendar_drug_label: "İlaç",
    calendar_time_label: "Saat",
    calendar_add_button: "Ekle",
    calendar_list_title: "Tüm Hatırlatıcılar",
    calendar_list_empty: "Henüz hatırlatıcı eklenmedi.",
  ...
  en: {
    ...
    guide_nav_qa: "Q&A",
    guide_nav_photo: "Analyze by Photo",
    ...
    photo_title: "Photograph or upload your medicine",
    photo_subtitle:
      "Take or upload a photo of a medicine box, blister, or leaflet — we'll match it against your local cabinet.",
    photo_camera_button: "Take Photo",
    photo_gallery_button: "Choose from Gallery",
    photo_upload_button: "Upload from Computer",
    photo_analyze_button: "Analyze",
    photo_analyzing: "Analyzing…",
    photo_remove_button: "Remove",
    photo_result_title: "Analysis Result",
    photo_matched_prefix: "Matched medicine:",
    photo_no_match: "No match found among your cabinet's medicines.",
    photo_error_type: "You can only upload an image file (JPEG, PNG, WEBP).",
    photo_disclaimer:
      "This analysis is generated by AI (Gemini) and may be inaccurate. Check the leaflet or consult your pharmacist for certainty.",

    calendar_prev: "← Previous",
    calendar_next: "Next →",
    calendar_today: "Today",
    calendar_empty: "No reminders for this date.",
    calendar_taken: "Taken",
    calendar_future_note: "You can't mark future dates as taken.",
    calendar_add_title: "Add New Reminder",
    calendar_person_label: "Person",
    calendar_person_self: "You",
    calendar_drug_label: "Medicine",
    calendar_time_label: "Time",
    calendar_add_button: "Add",
    calendar_list_title: "All Reminders",
    calendar_list_empty: "No reminders added yet.",
